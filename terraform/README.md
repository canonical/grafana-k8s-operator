...
| <a name="input_replace_triggers"></a> [replace\_triggers](#input\_replace\_triggers) | List of values that, when changed, trigger a full application replacement | `list(any)` | `[]` | no |
