...
async def test_build_and_deploy(
    ...
    # hotfix: refresh self-signed-certificates to 1/srtable.
    ...
    sh.juju.refresh(self_signed_certificates_app_name, channel="1/stable", model=ops_test.model_name)  # type:ignore[reportAttributeAccessIssue]
