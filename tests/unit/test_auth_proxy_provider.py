...
from charms.grafana_k8s.v0.grafana_auth import AuthProvider, GrafanaAuthProxyProvider
...
class TestDefaultGrafanaAuthProxyProvider(unittest.TestCase):
    ...
    def test_given_urls_are_in_relation_data_and_unit_is_leader_when_refresh_event_then_urls_avaialble_event_is_emitted(
    ...
    def test_given_relation_not_yet_created_when_refresh_event_then_urls_avaialble_event_is_not_emitted(
        self, mock_urls_available_event
    ):
        self.harness.container_pebble_ready("auth-tester")
