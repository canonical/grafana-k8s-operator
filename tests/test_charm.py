...
MINIMAL_CONFIG = {
    'grafana-image-path': 'grafana/grafana',
    'port': 3000
}
...
class TestCharm(unittest.TestCase):
    def setUp(self):
        ...
        self.minimal_datasource_hash = hashlib.md5(
            str(yaml.dump(MINIMAL_DATASOURCES_CONFIG)).encode('utf-8')).hexdigest()
    ...
    def test_datasource_config_is_updated_by_grafana_source_relation(self, push):
        ...
        self.assertEqual(self.harness.charm._stored.grafana_datasources_hash,
