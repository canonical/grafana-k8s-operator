...
class GrafanaDashboardConsumer(Object):
    ...
    def __init__(
        ...
        """Construct a Grafana dashboard charmed operator client.
        ...
        To use the :class:`GrafanaDashboardConsumer` API, you need a relation
        ...
        argument when instantiating the :class:`GrafanaDashboardConsumer` object.
        ...
        to be automatically managed by the :class:`GrafanaDashboardConsumer` object
